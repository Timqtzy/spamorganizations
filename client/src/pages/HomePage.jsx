      ...
      <div>
        ...
        <div className="py-12 sm:py-24 bg-gray-100">
          <section className="text-gray-600 body-font max-w-screen-xl mx-auto">
            <div className="container w-full px-5 py-12 s:py-2 sm:py-2 mx-auto s:mx-0 sm:mx-0">
              ...
              <div className="flex flex-wrap m-4">
                <div className="p-4 smd:w-1/3">
                  <div
                      className="flex rounded-lg h-full bg-white p-8 flex-col transition-all duration-300 hover:shadow-[0_0_15px_rgba(220,38,38,0.3)] hover:-translate-y-1">
                    <div className="flex items-center mb-3">
                      <div
                          className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-red-500 text-white flex-shrink-0 text-center">
                        <svg
                            fill="none"
                            stroke="currentColor"
                            strokeLinecap="round"
                        ...
                        >
                          <path
                              d="M8 21h8m-4-4v4m-4.5-9.5l-2-2m11 2l2-2M12 3c1.7 0 3 1.3 3 3 0 .8-.3 1.5-.8 2l-.7.7c-.4.4-.5.9-.5 1.3v1h-2v-1c0-.8.3-1.5.8-2l.7-.7c.4-.4.5-.9.5-1.3 0-.6-.4-1-1-1s-1 .4-1 1H9c0-1.7 1.3-3 3-3z"/>
                        </svg>
                      </div>
                ...
                <div className="p-4 smd:w-1/3">
                  <div
                    ...
                    <div className="flex items-center mb-3">
                      <div
                          className="w-8 h-8 mr-3 inline-flex items-center justify-center rounded-full bg-red-500 text-white flex-shrink-0">
                        <svg
                            fill="none"
                            stroke="currentColor"
                            strokeLinecap="round"
                  ...
                  <div
                    ...
                    <div className="flex items-center mb-3">
                      <div
                        ...
                        >
                          <path
                              d="M12 15l-3-3m0 0l3-3m-3 3h12M5 19a2 2 0 01-2-2V7a2 2 0 012-2h4l2 2h4a2 2 0 012 2v1M5 19h14a2 2 0 002-2v-5a2 2 0 00-2-2H9a2 2 0 00-2 2v5a2 2 0 01-2 2z"/>
                        </svg>
                      </div>
