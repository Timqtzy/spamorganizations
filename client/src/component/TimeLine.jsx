...
const YourComponent = () => {
  const { ref: sectionRef, inView: sectionInView } = useInView({
    ...
    threshold: 0.1, // Trigger the animation when 10% of the section is in view
  });
        ...
        <div className="bg-white text-white py-8">
          <div className="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
            <div className="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 px-8">
              ...
              <p className="text-3xl text-red-700 md:text-4xl leading-normal md:leading-relaxed mb-2">
                  ...
                  <div className="mb-8 flex justify-between flex-row-reverse items-center w-full left-timeline">
                    ...
                    <div className="order-1 w-5/12 px-1 py-4 text-right">
                      ...
                      <p className="text-sm md:text-base leading-snug text-left text-gray-500 text-opacity-100">
                        ...
                        by filling the form corresponding to that event. It's
                        that easy.
                      </p>
                    </div>
                  </div>
